...
export const checkboxVariants = cva({
  base: [
    "peer flex items-center justify-center size-4 shrink-0 bg-white border rounded shadow-inner shadow-black/10 text-primary-dark appearance-none transition-none",
